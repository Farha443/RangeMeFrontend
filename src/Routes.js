...
import PrivacyStatement from './component/home/PrivacyStatement';
    ...
    return(
        <>
            ...
            <Switch>
                ...
                <Route exact path="/validate-supplieotp" component={ForgotPassOTP}></Route>
                ...
                <Route exact path="/chatbox" component={Chatbox}></Route>
