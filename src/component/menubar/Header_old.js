    ...
    <div className="header-bar__actions">
      ...
      <div className="header-bar__link sub-nav__toggle">
        ...
        <div className="header-bar__angle">
          <svg xmlns="http://www.w3.org/2000/svg" className="svg" width={7} height={4}>
            <path className="svg__stroke" stroke="#000" d="M1 1l2.5 2.5L6 1" fill="none" strokeLinecap="round" strokeLinejoin="round" />
          </svg>
        </div>
